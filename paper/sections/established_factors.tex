...
rather than an alignment or a vacuous obstruction.  Whether a
modified (partially antilinear) tick rule admits the SM's chiral
coupling is a separate open question, addressed in Phase~1.5 of
the work plan.
