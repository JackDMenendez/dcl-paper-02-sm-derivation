...
\title{Geometry Forces Physics:\\
       ...
       %% Zenodo DOI to be filled in at release time:
       %% \href{https://doi.org/10.5281/zenodo.XXXXXXXX}%
       %%      {DOI: 10.5281/zenodo.XXXXXXXX}.
       \href{https://github.com/JackDMenendez/dcl-paper-02-sm-derivation}%
            {GitHub: JackDMenendez/dcl-paper-02-sm-derivation}.
       DOI to be assigned at Zenodo deposit.}}
