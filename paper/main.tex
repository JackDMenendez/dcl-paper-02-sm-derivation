...
\title{Geometry Forces Physics:\\
       ...
       \thanks{Version 2.0.  See the \textbf{Revision notice} above and
       the changes table overleaf.
       ...
       10.5281/zenodo.20078529}).  This paper:
       \href{https://doi.org/10.5281/zenodo.21477781}{DOI:
...
%% ---------------------------------------------------------------
%% REVISION NOTICE -- immediately BEFORE the abstract (author's
%% explicit instruction for v2.0; the other front-matter notices
%% remain after the abstract).  Verbatim author-approved text.
%% ---------------------------------------------------------------
\input{sections/revision_notice_v2}
...
The exact commit corresponding to this release is the v2.0 tag,
archived at
\href{https://doi.org/10.5281/zenodo.21477781}%
     {\nolinkurl{doi:10.5281/zenodo.21477781}}.
